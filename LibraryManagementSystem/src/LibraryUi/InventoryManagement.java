...
public class InventoryManagement extends javax.swing.JFrame {
    public static ArrayList <BookObj> BookList = new ArrayList<>();
    /**
    ...
    private void initComponents() {
        ...
        BookTable.setFont(new java.awt.Font("Times New Roman", 2, 14)); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(tfBuscar, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        jButton2.setText("Book Data Overview");
    ...
    private void tfBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfBuscarActionPerformed
        ...
        BookTable.setRowSorter(obj1);
        obj1.setRowFilter(RowFilter.regexFilter(tfBuscar.getText()));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        AddBook operationAdd = new AddBook();
        operationAdd.show();
    }//GEN-LAST:event_jButton4ActionPerformed

    public static void AddToList (BookObj newBook){
    ...
    public static void RefreshList (){
        ...
        for (int i = 0; i<= BookList.size();i++){
            //BookObj.actualBook = BookList.get(i);
            
            DefaultTableModel model = (DefaultTableModel) BookTable.getModel();
            BookObj checking = BookList.get(i);
            
            String authorAdd = checking.getAuthor();
            String titleAdd = checking.getTitle();
            String isbnAdd = checking.getIsbn();
           // String bookFAdd = checking.getBookForm();
            String editionAdd = checking.getEdition();
            
            String Data [] = {titleAdd,authorAdd,isbnAdd,/*bookFAdd*/editionAdd};
            model.addRow(Data);
        }
    }
    /**
